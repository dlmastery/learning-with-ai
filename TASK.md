# TASK.md — every ask, in the owner's own words

Reconstructed from the full session transcript, not from a summary. Asks are **verbatim**,
in the order given, with the owner's own spelling. Expletives are marked `[expletive]`;
nothing else is altered, softened or paraphrased.

Where an instruction was given more than once, the repeats are kept as separate rows,
because a repeated instruction is evidence the earlier fix was wrong.

Status: **done** · **partial** · **open** · **other project**

---

## Part A — the mission, stated by the owner

> **"what was my goal - move the frontier in learning and make it accessibel to all -
> using frontier ai capabilities"**

- *"i want university in a box school in a box - personalized for each student - instead of humans there will be agents - agent village for educcation - each agent is expert certified amazing. whether the student is selpa student or regular student - does not magtter - specifically helping selpa is a key goal as well."*
- *"my daughter is selpa student - remmebr this is personal."*
- *"ai tutor makes us all polymaths in very short period of time - things that take 1 week can be learnt in an hour - the best of the best tutor - think broad think big think deep"*
- *"ironman jarvis like tutor is the goal"*
- *"[expletive] all the trail crap think startrek think ekalavya.ai think next gen. this is furture looking"*
- *"i have prior art but that is my limited vision - think deep and wide - dont get biased with my tunnel vision - think the future. you are writing a new standard of learning with ai - the next generation of next generation"*
- *"there are a lot of ai doomers in edtech. ignore them. be bias free. be positive"*
- *"do not get misled by negative surveys"*
- *"we partner with the whole ecosystem publishers authors online sites"*
- *"a 500 dollar per hour tutor for everyone at tokens cost"*
- *"every book comes with a live ai mentor"*

---

## Part B — every ask, in order
...
| 12 | *"please continue where you left - i hve another ai look into repo and muck -check what it did as well"* | done |
| 13 | *"also research various learning systems like socrates etc.,."* | done — `I1`, `I2`, §19 |
| 14 | *"make the repo public"* | done |

### Dashboard, demos and taste

| # | The ask, verbatim | Status |
|---|---|---|
| 15 | *"how did we do did you provide dashboad in gihub.io using claue.ai/design style of a detailed report of everything bullish"* | done |
| 16 | *"did you build a spectaculor dashboard with this"* | done |
| 17 | *"where is the dashboard of all demos"* | done — `docs/demos/index.html` |
...
| 36 | *"can you do slop detector adversarial agents across all artifacts"* | done — 4 reviews → `check-voice.py` |
| 37 | *"the pitch deck is so full of [expletive] - you have a ocean of knowledge and you only anchor on textboook. so shame on you. grow up and do a good job. you are so pathetic."* | done |
| 38 | *"you are a elite startup founder in edtech"* | done |
| 39 | *"you are visionary"* | done |
...
| 47 | *"did you checkpoint github so far - use agent team to maximize parallelism and dynamic agent workflows to parallelize"* | done |
| 48 | *"the dashboard looks like you want to prove a point that ai for learning is garbage. that is exactly opposite of what i wanted. do you have even a tiny bit of commonsensee"* | done — `check-stance.py` enforces it |
| 49 | *"so do i need to go and check each artifact and tell you painstakingly or will do a broad sweep - i am so disappointed so far"* | done — machine checks so defects cannot recur unseen |
| 50 | *"do broad sweep and correct acrosss . what happned to ultra plan work. also so much research and so little demos ? what is going on - every aspect of tutoring - sweep research and see what you missed. do not get misled by negative surveys"* | done — 15 → 27 demos; coverage audit; 7 new reports, 7 new sections |
| 51 | *"parallelize as much as possible with agent teams"* | done — up to 11 concurrent |
| 52 | *"continue doing outstanding items i gave you includihng slop remoival"* | done |

### The outdated-metrics correction — asked four times

| # | The ask, verbatim | Status |
|---|---|---|
| 53 | *"how can i convince you to fix the screwup using outdated biased metrics - the whole negativity towards ai MUST go.. fix readme and all artifacts - also the deck is still bull [expletive] -cant you check other pitch decks ? did you push all changes to github"* | done |
| 54 | *"use agent teams to fix"* | done |
| 55 | *"ok enoujgh is enouugh - stop showing outdated study metrics to prove ai is bad tutor - i told you those are bullshit metrics."* | done — **I had been labelling them instead of deleting** |
| 56 | *"how many times i repeated this and my vision - why are you not fixing - do you have adhd ? [expletive] fix everywhere you idiot"* | done — 339 → 0, machine-verified |
...
Recorded so nothing is missed. These are separate work streams.

| The ask, verbatim | Status |
|---|---|
| *"check the status of hermes agent installed on this system. also watch [youtube] to install these skills in hermes agent"* | other project |
| *"https://github.com/dlmastery/meta_innovation_harness - implement the vision of this properly with hermes as the harness - with all the other clis as agents - do this as an independent task - after hermes is all setup. use agent teams in the mean time to scout and undersatnd and implement"* | other project |
| *"can you login to gh"* · *"i logged into github and agy"* · *"i did grok device authorization -=can you check now"* | other project |
| *"how do i connect rdp to this machine from windows - what is the user name and password"* · *"what are the steps in windows to connect"* · *"what is the password"* · *"it does not work - rdp. can you check what is the issue. the window comes and gos"* | other project |
| *"are addy osmani plugins installed in hermes"* | other project |
| *"what else can i do for hermes agent - i want hermes agent to become self scaffolding - self harness creator"* | other project |
| *"i want to establish the new bar of [youtube] - all applications i build will be agent first apps - write detailed plan for creating an agent first app leveraging the repos etc.,. discussed -= this is an independent agents task."* | other project |
| *"how do i access hermes dashboard"* | other project |
| *"what are the top comfyui skills/plugins for local ai in hermes - bring them in"* | other project |
| *"what is the status of agent first appliction"* | other project |
| *"https://github.com/BuilderIO/agent-native/ is the repo for this agent first applicaiton.k did you get everything -= learn everything"* | other project |
| *"build an extremely stunning the worlds best ai augmented todo list app using the agent native framework norms. it shuld be mobile friendly the very best of the best app. stunning dazzling amazing beaitiful."* | other project |
| *"please ddo the needful"* · *"status please"* · *"what is the status"* · *"launch all of them rery"* · *"hope you got sometig useful for research. refelct and update"* | done |
| `/loop` ×6 — *"continue till you accomplish all your goasl i gave - pass it on to an futuristic elitte educator and ensure it passes smell test and is no ai slop and is excellent"* | done |

---

## Part C — the instruction I got wrong four times

Asks 9, 53, 55 and 56 are the same instruction. *"there are a lot of ai doomers in edtech.
ignore them. be bias free. be positive"* was given early. It was repeated three more times
before I acted correctly.

**What was wrong.** The four most-cited numbers in the survey — Bloom's 2σ (1984, human
tutors), VanLehn (2011, rule-based systems), Nickow's pooled estimate (human-tutoring
trials), and two 2014 meta-analyses of rule-based courseware — were used as the ceiling for
a frontier system. **339 occurrences** across every reader-facing artifact.

**Why it took four attempts.** The first three passes *labelled* the numbers with their
system class and vintage. That is not what was asked, and it does not work: a label does not
stop a 1984 measurement from framing the argument. The fourth pass deleted them.

**Result: 339 → 0**, verified by machine.

**What the audit found on the way, which inverted my own diagnosis.** The 0.2–0.4 SD band
was never a pre-LLM pooled estimate. It is one sentence rounding **three LLM-era field
trials** — Sierra Leone +0.258, Nigeria +0.23–0.31, Rori +0.37 — with no *k*, no SE, no I²,
no confidence interval, and no averaging performed. Only the clause bolted onto it made it
read as a shared ceiling. §09 now turns it around: *effects in that band, replicated across
four countries, on a technology that did not exist in 2022.* The source's own headline —
**"at much lower cost"**, which the survey had dropped — is restored.

**Stated plainly:** documented nulls on rule-based courseware have left the argument. That
is a real reduction in adversarial surface. They remain in `research/raw/`, in §19 and in the
ledger. The case for removing them is that they never measured a frontier system, not that
they were wrong.

---

## Part D — what exists now
...
## Part F — my own failures on this project

Each produced a rule or a check. The record is the reason to trust the rest.

| What I did | What it cost | What stops it now |
|---|---|---|
| Labelled the legacy metrics three times when told to delete them | Four repeats of one instruction | `check-vintage.py`, whose own guidance said *"never delete"* until it was corrected |
...
| Wrote this file from my own summary first | Missed asks the summary had compressed away | Rebuilt from the raw transcript, 105 turns |

---

*Corrections to this file belong in this file. If an ask is recorded wrongly, that is itself
a correction and goes in the table.*
