...
"refusal-engine": (
 "The decision function of a tutor that would rather ask than answer, with every input exposed as a control. Move a slider and the verdict — <b>answer · ask · wait · pivot · escalate</b> — recomputes, along with the rule that fired.",
...
"patha": (
 ...
 "The Vedic <em>pāṭha</em> recitations permute word order deliberately, which <b>disables semantic autocorrect</b> — the exact failure mode of LLM paraphrase drift. We proposed adapting it as a fidelity check on model output. It was worth trying and it does not work.",
 "Corrupt a token and watch <em>krama</em> catch a transposition that plain recitation misses — that part is real and computed. Then read §4, which reports our own benchmark: <b>87.5%/87.5%</b> and <b>100%/100%</b>, exactly at chance, losing to plain self-consistency by 18.8 and 43.8 points. This is what publishing a falsification looks like."),
"cbm-probe": (
